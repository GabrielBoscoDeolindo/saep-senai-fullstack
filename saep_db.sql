...
CREATE TABLE `app_stockmovement` (
  ...
  PRIMARY KEY (`id`),
  KEY `app_stockmovement_product_id_fk` (`product_id`),
  KEY `app_stockmovement_user_id_fk` (`user_id`),
  CONSTRAINT `app_stockmovement_product_id_fk` FOREIGN KEY (`product_id`) REFERENCES `app_product` (`id`),
  CONSTRAINT `app_stockmovement_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `app_stockmovement_chk_1` CHECK ((`quantity` >= 0))
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

INSERT INTO `app_stockmovement` VALUES 
